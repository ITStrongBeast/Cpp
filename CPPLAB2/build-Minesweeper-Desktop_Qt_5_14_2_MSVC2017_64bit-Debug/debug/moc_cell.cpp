...
#include <memory>
#include "../../ct-c24-lw-minesweeper-GeorgeGolenkov1/cell.h"
...
QT_MOC_LITERAL(1, 5, 9), // "pressLeft"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 10), // "pressRight"
QT_MOC_LITERAL(4, 27, 8) // "pressMid"

    },
    "Cell\0pressLeft\0\0pressRight\0pressMid"
};
...
void Cell::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->pressLeft(); break;
        case 1: _t->pressRight(); break;
        case 2: _t->pressMid(); break;
        default: ;
        }
        ...
        {
            using _t = void (Cell::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Cell::pressLeft)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Cell::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Cell::pressRight)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Cell::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Cell::pressMid)) {
                *result = 2;
                return;
            }
        }
